...
internal static class VoiceMeeterRemote
{
    ...
    [DllImport(DLL, EntryPoint = "VBVMR_SetParameterFloat", CallingConvention = CallingConvention.StdCall)]
    public static extern int SetParameter([MarshalAs(UnmanagedType.LPStr)] string szParamName, float value);
    [DllImport(DLL, EntryPoint = "VBVMR_SetParameterStringW", CallingConvention = CallingConvention.StdCall)]
    public static extern int SetParameter([MarshalAs(UnmanagedType.LPStr)] string szParamName, [MarshalAs(UnmanagedType.BStr)] string value);
